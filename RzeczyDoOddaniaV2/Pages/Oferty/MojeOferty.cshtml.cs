...
{
    [Authorize]
    public class MojeOfertyModel : PageModel
    {
        ...
        public MojeOfertyModel(DataContext context, ILogger<IndexModel> logger, IWebHostEnvironment webHostEnvironment
        ...
        public async Task OnGetAsync()
        {
            ...
            {
                Oferty = await _ofertyDBService.GetOfertyByUser(_userManager.GetUserName(User));
